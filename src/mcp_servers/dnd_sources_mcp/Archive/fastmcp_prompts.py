...
from src.core.api_helpers import validate_dnd_entity, fetch_dnd_entity, get_primary_ability, get_asi_text, API_BASE_URL


def register_prompts(app):
    """Register prompt handlers with the app using direct handler assignment."""
    ...
    PROMPTS = {
        ...
        "encounter-builder": types.Prompt(
        ...
        "magic-item-finder": types.Prompt(
    ...
    # Define the list_prompts function
    ...
    # Define the get_prompt function
    async def get_prompt_handler(
        ...
        try:
            ...
            if name == "character-concept":
                ...
                raise ValueError(
                    f"Prompt implementation not found for: {name}")
        except Exception as e:
    ...
    app.list_prompts_handler = list_prompts_handler
    app.get_prompt_handler = get_prompt_handler
